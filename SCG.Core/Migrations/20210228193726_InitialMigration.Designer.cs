...
namespace SCG.Core.Migrations
{
    ...
    [Migration("20210228193726_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCG.Core.Database.Entities.UploadEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SCG.Core.Database.Entities.UserEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SCG.Core.Database.Entities.UserEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("SCG.Core.Database.Entities.UploadEntity", b =>
                {
                    b.HasOne("SCG.Core.Database.Entities.UserEntity", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
